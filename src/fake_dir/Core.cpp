...
{
	auto vertShaderCode = readFile(R"(C:\Users\Arouay\source\repos\vk-draft\src\shaders\shader.spv)");
	auto fragShaderCode = readFile(R"(C:\Users\Arouay\source\repos\vk-draft\src\shaders\frag.spv)");
