...
namespace dvk {
    ...
    bool _Core::checkValidationLayerSupport()
    {
    ...
    VkBool32 VKAPI_CALL _Core::debugCallback(
    ...
    void _Core::fillDebugUtilsMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
    {
    ...
    VkResult _Core::createDebugUtilsMessengerEXT(
            VkInstance instance,
    ...
    void _Core::destroyDebugUtilsMessengerEXT(
            VkInstance instance,
    ...
    void _Core::setupDebugMessenger()
    {
    ...
    std::vector<const char*> _Core::getRequiredExtensions()
    {
    ...
    void _Core::checkExtensionsCompatibility(std::vector<const char*>& glfwExtensions, std::vector<VkExtensionProperties>& vkCompatibleExtensions)
    {
    ...
    bool _Core::checkDeviceExensionsSupport(VkPhysicalDevice device)
    {
    ...
    deprecated::QueueFamilyIndices _Core::findQueueFamilies(VkPhysicalDevice device)
    {
    ...
    bool _Core::isDeviceSuitable(VkPhysicalDevice device)
    {
...
//			break;
    ...
    void _Core::createLogicalDevice()
    {
    ...
    VkSurfaceFormatKHR _Core::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
    {
    ...
    VkPresentModeKHR _Core::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> availablePresentModes)
    {
    ...
    VkExtent2D _Core::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
    {
    ...
    std::vector<char> _Core::readFile(const std::string& fileName)
    {
    ...
    VkShaderModule _Core::createShaderModule(const std::vector<char>& code)
    {
    ...
    void _Core::createGraphicsPipeline()
    {
        auto vertShaderCode = readFile(R"(C:\Users\Arouay\Documents\Projects\draft-vk\resources\shaders\shader.spv)");
        auto fragShaderCode = readFile(R"(C:\Users\Arouay\Documents\Projects\draft-vk\resources\shaders\frag.spv)");
    ...
    void _Core::createCommandBuffers()
    {
